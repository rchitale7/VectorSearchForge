...
def persistMetricsAsCSV(workloadType: WorkloadTypes, allMetrics: dict, workloadName: str, indexType: IndexTypes):
    ...
    fields = ["workload-name", "indexType", "dataset-name", "dimensions", "vectors-count", "queries-count", "indexing-params", "index-creation-time", "gpu-to-cpu-index-conversion-time", "write-to-file-time", "write-index-time", "total-build-time", "peak-gpu-memory-usage", "peak-cpu-memory-usage", "search-parameter", "search-time", "unit", "search-throughput", "recall@100", "recall@1"]
    rows = []
