...
def executeWorkload(
    ...
    if (
        ...
        indexingMetrics = doIndexing(
            workloadToExecute, dataset_file, indexType
        )
    ...
    for indexingParam in workloadToExecute["indexing-parameters"]:
        ...
        if indexType == IndexTypes.GPU:
            for compression in workloadToExecute['compression']:
                ...
                metrics = get_search_metrics(workloadToExecute, indexType, indexingParam, xq, gt)
    ...
    try:
        ...
        if indexType == IndexTypes.GPU:
            ...
            timingMetrics = indexDataInCpu(
                workloadToExecute["dimension"], xb, ids, indexingParam, space_type, file_to_write=graph_file
            )
