...
class FaissIndexBuildService(IndexBuildService):
    ...
    def build_index(
        ...
        try:
            ...
            start = timer()
            faiss_gpu_build_index_output = faiss_gpu_index_cagra_builder.build_gpu_index(
            ...
            start = timer()
            faiss_cpu_build_index_output = faiss_index_hnsw_cagra_builder.convert_gpu_to_cpu_index(
